...
public class BookServiceImpl implements BookService {
    ...
    private final static String BOOKS_FILE_PATH
            = "D:\\My Documents\\Java DB\\Hibernate\\6.SPRING DATA ADVANCED QUERING\\advancedqueringexersice\\src\\main\\resources\\files\\books.txt";
    ...
    @Override
    public List<String> getAllBookTitlesWithAgeRestriction() {
    ...
    @Override
    public List<String> getAllBookTitlesWithLess5000Copies() {
        int count = 5000;
        EditionType editionType = EditionType.GOLD;

        return this.bookRepository.findAllByEditionTypeEqualsAndCopiesLessThan(editionType, count)
                .stream()
                .map(b -> String.format("%s", b.getTitle()))
                .collect(Collectors.toList());
    }
    ...
    @Override
    public List<String> getAllBooksWithPriceLessThan5AndGreaterThan40() {
